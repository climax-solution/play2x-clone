<div class="game__wrapper">
    <div class="col-md-3 col-sm-12 g_sidebar" data-parent="#w_container">
        <div class="row g_follow">
            ...
            <div class="col-xs-12 col-sm-12 mt5">
                <div class="g_s g_btn" onclick="minesauto()" id="auto" style="display: none;"><span
                        id="bet_btn_auto">Run</span></div>
            </div>
...
transform:translateX(100%);
        ...
        <div class="cf_info cf_info_m">
            ...
            <div class="mines_grid">
                @for($i = 0; $i < 5 * 5; $i++) <div data-grid-id="{{$i}}" class="mine_disabled">
            </div>
            @endfor
        </div>
