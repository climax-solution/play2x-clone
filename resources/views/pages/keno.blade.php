    ...
    <div class="col-md-3 col-sm-12 g_sidebar" data-parent="#w_container">
        <div class="row g_follow">
            <div class="row m0">
                ...
                <div class="game-sidebar-tabs">
                    <div class="game-sidebar-tab active" onclick="setMode('default')" data-tab="default">Manual</div>
                    <div class="game-sidebar-tab" onclick="setMode('auto')" data-tab="auto">Auto</div>
                </div>
                <div class="col-xs-12">
                    <div class="b_label">
                        Amount
                ...
                <div class="col-xs-12 mb10 mt5">
                    ...
                    <div class="buttons-2">
                        <div onclick="autopick()" class="buttons-2-selected"><i class="fas fa-magic"></i>&nbsp;
                            Auto Pick</div>
                        <div onclick="clearkeno()" class="">Clear Table</div>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 mt5">
                <div class="g_s g_btn" onclick="kenoauto()" id="auto" style="display: none;"><span
                        id="bet_btn_auto">Launch</span></div>
            </div>
        </div>
        <div class="g_sidebar_footer">
            ...
            <div class="g_sidebar_footer_button" onclick="setAudioGame(!isAudioGame)">
                <script>
                $(document).ready(function() {
                    isAudioGame ? ($("#game_audio_on").fadeIn(0), $("#game_audio_off").fadeOut(0)) : ($(
                        "#game_audio_off").fadeIn(0), $("#game_audio_on").fadeOut(0))
                });
                </script>
...
transform:translateX(100%);
        ...
        <div class="keno_container">
            <div class="keno_grid">
                @for($i = 1; $i <= 40; $i++) <div data-keno-id="{{$i}}"><span>{{$i}}</span></div>
            @endfor
        </div>
