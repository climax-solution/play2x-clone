        ...
        <div class="md-content">
            ...
            <div class="email-container">
                ...
                <div class="email_links">
                    ...
                    <a href="javascript:void(0)" onclick="window.location.href='/logout'" class="ll"
                        style="margin-left: 5px">Log out of your account</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="md-content">
            ...
            <div class="login_fields">
                <div class="login_fields__user" id="email" style="display: none">
                    ...
                    <i class="fas fa-info-circle register-email-info tooltip"
                        title="Please use your real email as an email will be sent to it with a confirmation link."></i>
                </div>
                ...
                <div class="login_fields__submit">
                    <input type="submit" id="l_b" value="Signin">
                </div>
            </div>
            <div class="social_auth_block">
                <div class="through_social through_vk" onclick="socialAuth('vk')">
                    <i class="fab fa-vk"></i> <span class="hidden-x">VKontakte</span>
                </div>
                <div class="through_social through_google" onclick="socialAuth('google')">
                    <i class="fab fa-google"></i> <span class="hidden-x">Google</span>
                </div>
            </div>
            <div class="social_auth_desc">By entering the site, you <a href="javascript:void(0)" onclick="load('faq')"
                    class="colored-link">accept the terms</a>of the license agreement and confirm that you are over 18
                years old</div>
        </div>
    </div>
    @else
                        ...
                        <div class="wallet-area__row">
                            ...
                            <div class="sum-options">
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(50) && $('#payment1').val(50)">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(100) && $('#payment1').val(100)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(250) && $('#payment1').val(250)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(500) && $('#payment1').val(500)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(1000) && $('#payment1').val(1000)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(2500) && $('#payment1').val(2500)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(5000) && $('#payment1').val(5000)">
                                        <div class="sum-option__value">
                                ...
                                <div class="sum-option-wrapper">
                                    <button class="sum-option" href="javascript:void(0)"
                                        onclick="$('#payment').val(10000) && $('#payment1').val(10000)">
                                        <div class="sum-option__value">
                                    ...
                                    <div class="payment-field payment-sum">
                                        ...
                                        <div class="validation-wrapper">
                                            ...
                                            <div class="wallet-input-wrapper">
                                                <input inputmode="numeric" type="tel" name="amount" id="payment"
                                                    value="{{$settings->min_in}}"
                                                    class="numeric-input-validate game-sidebar__input game-sidebar__input_dark"
                                                    required placeholder="Top up amount">
                                ...
                                <div class="payment-total__second-row">
                                    <div class="payment-result">
                                        <div class="payment-result__row">
                                            ...
                                            <div class="payment-result__row-value payment-result__row-value_comission">
                                                0%</div>
                                        </div>
                                        <div class="payment-result__row">
                                            <input type="hidden" name="payway">
                                            <div type="submit"
                                                class="game-sidebar__play-button game-sidebar__play-button_green pay_button"
                                                id="payin">Pay</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-8 payment-method-table p2">
                        <div class="wallet-area__row">
                            <div class="wallet-area__payway">
                                ...
                                <img class="wallet-area__payway-image" src="/img/qiwi_color.png" id="withdraw_icon"
                                    alt="">
                        ...
                        <div class="wallet-area__row">
                            ...
                            <div class="validation-wrapper withdraw-wallet-field">
                                <span class="validation-message"></span>
                                <div class="wallet-input-wrapper">
                                    <input placeholder="Wallet" id="purse" type="text" name="withdraw-wallet"
                                        class="game-sidebar__input game-sidebar__input_dark" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="wallet-area__delimiter">
                        ...
                        <div class="wallet-area__row">
                            <div class="payment-total">
                                <div class="payment-total__first-row">
                                    <div class="payment-field payment-sum">
                                        <label class="payment-field-label" for="deposit-sum">Amount<span
                                                class="sm-hidden">of output</span>
                                        </label>
                                        <div class="validation-wrapper">
                                            <span class="validation-message"></span>
                                            <div class="wallet-input-wrapper">
                                                <input inputmode="numeric" value="{{$settings->min_with}}" type="text"
                                                    name="amount" id="withv" data-what="Sum"
                                                    placeholder="Withdrawal amount" data-min="{{$settings->min_with}}"
                                                    data-max="15000" data-value-on-nonnumeric="1000"
                                                    class="numeric-input-validate game-sidebar__input game-sidebar__input_dark"
                                                    autocomplete="off">
                                ...
                                <div class="payment-total__second-row">
                                    ...
                                    <div class="withdraw-result__row">
                                        <input type="hidden" name="payway">
                                        <button
                                            class="game-sidebar__play-button game-sidebar__play-button_green withdraw_button"
                                            id="payout">Withdraw</button>
                                    </div>
                                </div>
        ...
        <div class="md-content">
            ...
            <div class="wheel_block row" id="wheel_block">
                ...
                <div class="bonus-fy-overlay">
                    <div class="col-xs-12 col-sm-6 bonus_reload" style="padding-left: 25px; cursor: pointer;"
                        onclick="window.open('https://vk.com/{{$settings->vk_url}}', '_blank')">
                        <span><i class="fab fa-vk"></i> VKontakte</span>
                        <p style="font-size: 11px;">Join the group and receive a free bonus every 3 minutes!</p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="spin_button" style="left: 63%;"
                            onclick="window.open('https://vk.com/{{$settings->vk_url}}', '_blank'); setTimeout($('.bonus-fy-overlay').fadeOut('fast'), 1500)">
                            Go</div>
                    </div>
                </div>
                @endif
    ...
    <div class="md-modal md-promo md-s-height md-effect-1">
        <div class="md-content">
            ...
            <div style="margin-top: 14px;">
                <div class="vk-btn2" onclick="window.open('https://vk.com/{{$settings->vk_url}}', '_blank')"><i
                        class="fab fa-vk"></i> Promo codes</div>
                <input style="width: 92%;" class="b_input_s bg_bet_input" id="_promo" placeholder="Промокод">
                <div class="bg_bet_btn" style="padding: 8px;" onclick="activatePromo($('#_promo').val())"><i
        ...
        <div class="md-content">
            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        <li>
                            <p style="text-align: center">Five random people every 3 hours are selected by the system
                                and awarded a bonus, simultaneously sending a message about it in the chat.</p>
                        </li>
                        <li>
                            <p style="text-align: center">To get caught in the rain, you must top up your account with
                                30 coins or more in the last 24 hours.</p>
                        </li>
                    </ul>
                </div>
            </div>
