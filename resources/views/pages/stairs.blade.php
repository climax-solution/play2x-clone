        ...
        <div class="row g_follow">
            <div class="row m0">
                ...
                <div class="col-xs-12 mt10">
                    ...
                    <input id="bet" data-number-input="true" value="<?= Auth::guest() ? '100.00' : '0.15' ?>"
                        type="text" class="b_input">
        ...
        <div class="stairs-container">
            <div class="stairs-centered" id="stairs_container">
                ...
                <div class="stairs-row">
                    @for($i = 0; $i < 8; $i++) <div class="stairs-block stairs-block-disabled" data-row="13"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 9; $i++) <div class="stairs-block stairs-block-disabled" data-row="12"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 10; $i++) <div class="stairs-block stairs-block-disabled" data-row="11"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 19; $i++) <div class="stairs-block stairs-block-disabled" data-row="10" data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 9; $i++) <div class="stairs-block empty-stairs-block">
                    </div> @endfor
                    @for($i = 0; $i < 11; $i++) <div class="stairs-block stairs-block-disabled" data-row="9" data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 8; $i++) <div class="stairs-block empty-stairs-block">
                    </div> @endfor
                    @for($i = 0; $i < 12; $i++) <div class="stairs-block stairs-block-disabled" data-row="8" data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    ...
                    <div class="stairs-block empty-stairs-block"></div>
                    <div class="stairs-block empty-stairs-block"></div>
                    @for($i = 0; $i < 17; $i++) <div class="stairs-block stairs-block-disabled" data-row="7"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    <div class="stairs-block empty-stairs-block"></div>
                    <div class="stairs-block empty-stairs-block"></div>
                    @for($i = 0; $i < 15; $i++) <div class="stairs-block stairs-block-disabled" data-row="6"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                    <div class="stairs-block empty-stairs-block"></div>
                    <div class="stairs-block empty-stairs-block"></div>
                ...
                <div class="stairs-row">
                    @for($i = 0; $i < 19; $i++) <div class="stairs-block stairs-block-disabled" data-row="5"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    ...
                    <div class="stairs-block empty-stairs-block"></div>
                    <div class="stairs-block empty-stairs-block"></div>
                    @for($i = 0; $i < 17; $i++) <div class="stairs-block stairs-block-disabled" data-row="4"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    <div class="stairs-block empty-stairs-block"></div>
                    @for($i = 0; $i < 19; $i++) <div class="stairs-block stairs-block-disabled" data-row="3"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 19; $i++) <div class="stairs-block stairs-block-disabled" data-row="2"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
                <div class="stairs-row">
                    @for($i = 0; $i < 20; $i++) <div class="stairs-block stairs-block-disabled" data-row="1"
                        data-cell-id="{{$i}}">
                    </div> @endfor
                </div>
            </div>
